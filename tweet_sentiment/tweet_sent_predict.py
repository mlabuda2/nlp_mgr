...
dataset = pd.read_csv("/home/mati/nlpmgr/tweet_sentiment/training.1600000.processed.noemoticon.csv",
                         header=None,
...
# print("Word Dict : ",tweet_tokenizer_word_dict[:50])
...
glove_file = open('/home/mati/nlpmgr/glove/glove.twitter.27B/glove.twitter.27B.100d.txt', encoding="utf8")
